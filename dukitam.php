...
<?php include 'bin/access/index/header.php';?> 
	...
	<div class="limiter">
		<div class="container-login100">
            ...
            <br/><br/>
				<form class="login100-form validate-form" role="form" action="http://localhost/social/addnew/success.xml" method="post" enctype="multipart/form-data">
					
                    
                 <div class="wrap-input100 validate-input" data-validate = "Input your First Name.">
                    ...
                    <div class="wrap-input100 validate-input" data-validate = "Input your Last Name.">
                    ...
                    <div class="wrap-input100 validate-input" data-validate = "Input your username.">
              ...
              <div class="wrap-input100 validate-input" data-validate = "Valid email is: x@y.z">
					...
					<div class="wrap-input100 validate-input" data-validate = "Input your gender.">
...
<option value="What was the name of the company where you had your first job?">What was the name of the company where you had your first job? </option>
                    ...
                    <div class="wrap-input100 validate-input" data-validate = "Input your country name.">
...
<option value="Zimbabwe">Zimbabwe</option>
					...
					<label class="margin-bottom-15">
							By clicking Create Account, you agree to our <a rel="nofollow" href="!">Terms and confirm</a> that you have read our <a rel="nofollow" href="!">Data Policy</a>, including our <a rel="nofollow" href="!">Cookie Use Policy</a>. You may receive SMS message notifications from <a rel="nofollow" href="!">Yokoll</a> and can opt out at any time.</label>                
					...
					<div class="text-center">
						...
						<a class="txt2" title="Log in" href="http://localhost/social/">
							Log in
						</a>
					</div>
