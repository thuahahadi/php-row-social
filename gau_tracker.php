...
<?php
				...
				$accepted='accepted';
				$result10 = mysql_query("SELECT * FROM friends WHERE requested='".$_SESSION['SESS_MEMBER_ID'] ."' and status='$accepted'");
								
								
								while($row6 = mysql_fetch_array($result10))
								  {
								  $qwe=$row6['addedby'];
				
				
							$hamim3 = mysql_query("SELECT * FROM members_post ORDER BY name='$qwe'");
		   ...
		   $hamim4 = mysql_query("SELECT * FROM members where user='$kigur_post' order by id DESC LIMIT ".$_POST["start"].", ".$_POST["limit"]."");
      ...
      <div class="comment_area">
        ...
        <?php
		 $hamim6 = mysql_query("SELECT * FROM post_comment where commentid='$montobbo' ORDER BY RAND() LIMIT 6");
            ...
            <?php echo'<strong> <a href=http://localhost/social/user/'.$tuhan6["user"] .'><font size="3px">'.$tuhan6['fname'].' '.$tuhan6['lname'].'</font>&nbsp;'.$tuhan6['verified'].'</a></strong>';?><br/>
...
echo '<source src="http://localhost/social/bin/access/images/member/comment/'.$tuhan5['images'].'"  >';
    ...
    <div align="right" style="margin-top:-17px">
        ...
        <a href="http://localhost/social/feedback/replay/<?php echo $tuhan5['id'];?>">
