      ...
      <div class="comment_area">
        ...
        <?php
		 $hamim6 = mysql_query("SELECT * FROM post_comment where commentid='$montobbo' ORDER BY RAND() LIMIT 6");
            ...
            <span class="text-muted  comment_time pull-right"><a title="Delete Feedback" href="http://localhost/social/post/delete/feedback/<?php echo $tuhan5["id"] ;?>"><img src="http://localhost/social/bin/access/images/icon/bin.PNG" alt="" height="16" width="16"></a>&nbsp;
		<a title="Edit Feedback" href="http://localhost/social/post/edit/feedback/<?php echo $tuhan5["id"];?>"><img src="http://localhost/social/bin/access/images/icon/edit.PNG" alt="" height="18" width="18"></a></span>
