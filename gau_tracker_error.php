...
<?php
				...
				$post_id=$_SESSION['user_profile_error'];
    
                    $public='public';
    
		$hamim3 = mysql_query("SELECT * FROM members_post Where name='$post_id' and share='$public' LIMIT ".$_POST["start"].", ".$_POST["limit"]."");
      ...
      <div class="comment_area">
        ...
        <?php
		 $hamim6 = mysql_query("SELECT * FROM post_comment where commentid='$montobbo' ORDER BY RAND() LIMIT 6");
            ...
            <?php echo'<strong> <a href=http://localhost/social/user/'.$tuhan6["user"] .'>'.$tuhan6['fname'].' '.$tuhan6['lname'].'&nbsp;'.$tuhan6['verified'].'</a></strong>';?><br/>
