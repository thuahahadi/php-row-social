...
<nav class="navbar">
    ...
    <ul class="nav">
      <li class="dropdown">
        ...
        <ul class="dropdown-menu">
          <li><a href="http://localhost/social/search/search/?query=<?php echo $_SESSION['search'];?>"><?php echo $_SESSION['search'];?> Tracker</a></li>
  ...
  <div class="row">
       ...
       <div class="col-md-2"></div>
             ...
             <div class="Right_h" align="center"><b>Search Result: At "<?php echo $_SESSION['search'];?>" tracker post</b></div><hr/>
     ...
     $public='public';
                  ...
                  //echo $q;
							$hamim3 = mysql_query("SELECT * FROM members_post Where share='$public' and location like '%$q%' order by id DESC ");
