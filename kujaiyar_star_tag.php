...
<nav class="navbar">
  ...
  <div class="row">
       ...
       <div class="col-md-2"></div>
             ...
             <div class="Right_h" align="center"><b>Search Result: StarTags-*<?php echo $_SESSION['search'];?></b></div><hr/>
     ...
     $public='public';
                  ...
                  //echo $q;
							$hamim3 = mysql_query("SELECT * FROM members_post Where share='$public' and content like '%$q%' order by id DESC ");
